...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:help@servicelocal.in?subject=${subject}&body=${body}`;
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
          <div className="flex items-center space-x-3 mb-6 pb-6 border-b border-gray-200">
            ...
            <div>
              ...
              <a href="mailto:help@servicelocal.in" className="text-emerald-600 hover:text-emerald-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <p className="text-sm text-gray-500">
              Send Message opens your email app (Gmail, Outlook, or default client) with this message pre-filled. Send
              from there when you are ready.
            </p>
